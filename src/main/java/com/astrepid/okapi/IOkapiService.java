...
public interface IOkapiService {
	 ...
	 * @throws OTException en cas d'erreur
	 */
	OkapiTracking getTracking(final String numeroSuivi, final OTLanguage langue) throws OTException;
	 ...
	 * @throws OTException en cas d'erreur
	 */
	List<OkapiTracking> getTracking(final List<String> numerosSuivi, final OTLanguage langue) throws OTException;
}
